...
export class Endpoint extends pulumi.CustomResource {
  ...
  public static get(
    ...
    return new Endpoint(name, state as any, { ...opts, id: id });
  }
  ...
  declare public readonly pgSettings: pulumi.Output<
...
export interface EndpointState {
  ...
  pgSettings?: pulumi.Input<Record<string, pulumi.Input<string>>>;
  /**
   * Activate connection pooling. See details: https://neon.tech/docs/connect/connection-pooling
   */
