...
export function getEnvBoolean(...vars: string[]): boolean | undefined {
  ...
  if (s !== undefined) {
    ...
    if (
      ["1", "t", "T", "true", "TRUE", "True"].some((v) => v === s) !== undefined
    ) {
      return true;
    }
    if (
      ["0", "f", "F", "false", "FALSE", "False"].some((v) => v === s) !==
      undefined
    ) {
      return false;
    }
...
let _packageRef: undefined | string = undefined;
  ...
  if (_packageRef === undefined) {
    ...
    if (_packageRef === undefined) {
      ...
      params.setValue(
        Uint8Array.from(
          atob(
            "eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2tpc2xlcmRtL25lb24iLCJ2ZXJzaW9uIjoiMC4xMy4wIn19",
          ),
          (c) => c.charCodeAt(0),
        ),
      );
