...
export class VpcEndpointRestriction extends pulumi.CustomResource {
  ...
  public static get(
    ...
    return new VpcEndpointRestriction(name, state as any, { ...opts, id: id });
  }
  ...
  constructor(
    ...
    if (opts.id) {
      ...
      resourceInputs["vpcEndpointRestrictionId"] =
        state?.vpcEndpointRestrictionId;
    } else {
