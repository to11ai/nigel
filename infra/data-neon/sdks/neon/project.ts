...
export class Project extends pulumi.CustomResource {
  ...
  public static get(
    ...
    return new Project(name, state as any, { ...opts, id: id });
  }
   ...
   */
  declare public readonly allowedIpsProtectedBranchesOnly: pulumi.Output<
    string | undefined
  >;
  /**
   ...
   */
  declare public readonly blockPublicConnections: pulumi.Output<
    string | undefined
  >;
  /**
   ...
   * VPC endpoints.
   */
  declare public readonly blockVpcConnections: pulumi.Output<
    string | undefined
  >;
  declare public readonly branch: pulumi.Output<
    outputs.ProjectBranch | undefined
  >;
  /**
   ...
   */
  declare public readonly enableLogicalReplication: pulumi.Output<
    string | undefined
  >;
  /**
   ...
   */
  declare public readonly historyRetentionSeconds: pulumi.Output<
    number | undefined
  >;
  /**
   ...
   * means 'unlimited'.
   */
  declare public readonly quota: pulumi.Output<
    outputs.ProjectQuota | undefined
  >;
  /**
  ...
  constructor(
    ...
    if (opts.id) {
      ...
      resourceInputs["allowedIpsProtectedBranchesOnly"] =
        state?.allowedIpsProtectedBranchesOnly;
      ...
      resourceInputs["defaultEndpointSettings"] =
        state?.defaultEndpointSettings;
      resourceInputs["enableLogicalReplication"] =
        state?.enableLogicalReplication;
      resourceInputs["historyRetentionSeconds"] =
      ...
      resourceInputs["allowedIpsProtectedBranchesOnly"] =
        args?.allowedIpsProtectedBranchesOnly;
