...
export const nigelTools = {
  ...
  linear_comment: linearCommentTool,
  linear_attach: linearAttachTool,
...
const {
  ...
  linear_get_issue: _unusedLinearGetIssueTool,
  linear_comment: _unusedLinearCommentTool,
  linear_attach: _unusedLinearAttachTool,
